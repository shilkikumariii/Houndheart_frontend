                            ...
                            <div>
                                ...
                                <div className="flex items-center justify-center gap-3 mb-6">
                                    ...
                                    <button
                                        ...
                                        className={`relative w-14 h-7 rounded-full cursor-pointer transition-colors ${billingPeriod === 'yearly' ? 'bg-purple-600' : 'bg-gray-300'
                                            }`}
                                    >
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <button
                                                    ...
                                                    className={`w-full py-2.5 px-4 rounded-xl font-semibold text-sm transition-all duration-200 ${isFree
